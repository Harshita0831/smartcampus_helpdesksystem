...
A RESTful API built with Django and Django REST Framework to manage complaints/tickets.
The system allows users to create, track, update, and filter complaints with authentication and pagination support.
